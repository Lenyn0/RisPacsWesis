...
class PatchFeatureExtractor(torch.nn.Module):
    ...
    def load(
        ...
        featuresampler=anomalyDetection.sampler.IdentitySampler(),
        nn_method=anomalyDetection.wscxr.common.FaissNN(False, 4),
        **kwargs,
    ):
    ...
    def load_from_path(
        ...
        feature_exetractor_params["backbone"] = anomalyDetection.wscxr.backbones.load(
