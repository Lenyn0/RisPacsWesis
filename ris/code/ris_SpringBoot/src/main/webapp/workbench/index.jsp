					...
					<form class="form-horizontal" role="form">
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" class="form-control" autocomplete="off" id="oldPwd" style="width: 200%;">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" class="form-control" autocomplete="off" id="newPwd" style="width: 200%;">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" class="form-control" autocomplete="off" id="confirmPwd" style="width: 200%;">
...
<%--				<div class="modal-body">--%>
<%--					<form class="form-horizontal" role="form">--%>
<%--						<div id="mainDiv">&lt;%&ndash;人脸识别的图像采集区域&ndash;%&gt;</div>--%>
<%--					</form>--%>
<%--					<label for="msg" class="col-sm-2 control-label"></label>--%>
<%--					<div class="col-sm-10" style="width: 300px;">--%>
<%--						<span id="msg2"></span>--%>
