...
<form action="workbench/register/save.do" id="registerForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" autocomplete="off" id="create-patientname" name="name" placeholder="支持自动补全(不存在则新建)">
        </div>
        <label for="create-patientnamePinYin" class="col-sm-2 control-label">姓名拼音<span style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-patientnamePinYin" name="namePinYin">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-ageType" name="ageType">
