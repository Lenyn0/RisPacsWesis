...
package com.by.ris_springboot.web.dcmqrscp;
...
public class DcmQRSCP {
    ...
    //执行构造函数之前，先执行final限定的变量和new操作的对象
    ...
    private final class CFindSCPImpl extends BasicCFindSCP {
        ...
        private boolean relational(Association as, Attributes rq) {
            String cuid = rq.getString(Tag.AffectedSOPClassUID);//与操作相关的受影响的SOP类UID，标识是进行的MOVE操作还是FIND操作等
    ...
    public DcmQRSCP() throws IOException {
        ...
        /*
        createServiceRegistry() 内部添加了很多服务类CStoreSCPImpl、CFindSCPImpl等
         */
...
////        String[] args2={"-b","DCMQRSCP:11112","--dicomdir","C:\\Users\\admin\\Desktop\\dcm4che-5.21.0-bin\\dcm4che-5.21.0\\bin\\disk99\\DICOMDIR"};
...
//        String[] args={"-b","DCMQRSCP:11112","--dicomdir","C:\\Users\\admin\\Desktop\\dcm4che-5.21.0-bin\\dcm4che-5.21.0\\bin\\disk99\\DICOMDIR"};
//        mainAccess(args);
//    }
    public static void worlistService(String[] args) {
        System.out.println("进入worlistService服务函数");
//        for (String s :
//                args) {
...
//            configureDicomFileSet(main, cl);
            ...
            main.setErrorCFind(CLIUtils.getIntOption(cl, "cfind-error", 0));//设置 CFind 错误码是 0
